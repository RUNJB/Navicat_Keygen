...
namespace Navicat_Keygen_Patch_By_DFoX
{
    public partial class FNavicat : Form
    {
        ...
        private string[] langname = { "en-GB", "es-ES", "fr-FR", "de-DE", "pl-PL", "pt-PT", "ru-RU", "ko-KR", "zh-CHS", "Japanese", "ja-JP" };
        ...
        private void bgenerateactivation_Click(object sender, EventArgs e)
        {
            ...
            if ((rn12.Checked || resse12.Checked) && trequestcode.Text.Trim() == String.Empty)
            {
            ...
            if ((rn12.Checked || resse12.Checked) && DeviceIdentifier == null)
            {
            ...
            try
            {
                ...
                byte[] bytelic = Encoding.ASCII.GetBytes(lic);
                byte[] licenza = eng.ProcessBlock(bytelic, 0, bytelic.Length);
                if (rn12.Checked || resse12.Checked)
                {
